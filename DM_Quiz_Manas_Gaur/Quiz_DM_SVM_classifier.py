...
#for items in X:
 #   print items
f = open('trained_SVM_classifier.pkl', 'w')
clf = svm.SVC(kernel='linear',C=1.0)#LogisticRegression()
#Cs = range(1, 10)
...
prediction=open("QUIZ_DM_Predictions_SVM.txt","w")
...
for items,tweets in zip(pred_output,Tweets):
    ...
    prediction.write("\n")
prediction.close()
print " QUIZ_DM_Predictions_SVM.txt has been created"
...
prediction=open("QUIZ_DM_Predictions_unlabeled_tweets_SVM.txt","w")
...
for items,tweets in zip(pred_output,Tweets):
    ...
    prediction.write("\n")
prediction.close()
print "QUIZ_DM_Predictions_unlabeled_tweets_SVM.txt has been created"